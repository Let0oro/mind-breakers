                    ...
                    <div className="space-y-6">
                        <div>
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {[1, 2, 3].map(i => (
                                    <div key={i} className="h-12 rounded-lg bg-gray-100 border-2 border-gray-200"></div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div>
                            ...
                            <div className="h-64 w-full rounded-lg bg-gray-100 border border-gray-300"></div>
                        </div>
