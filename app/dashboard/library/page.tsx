        ...
        <>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
                <div className="border border-border bg-main p-4">
                    <p className="text-xs font-bold uppercase tracking-widest text-muted mb-1">Courses</p>
                    <p className="text-3xl font-black text-text-main">{courses.length}</p>
                </div>
                <div className="border border-border bg-main p-4">
                    <p className="text-xs font-bold uppercase tracking-widest text-muted mb-1">Paths</p>
                ...
                <div className="border border-border bg-main p-4">
                    <p className="text-xs font-bold uppercase tracking-widest text-muted mb-1">Exercises Done</p>
            ...
            <Section
                ...
                createHref="/dashboard/quests/new"
                createLabel="New"
            ...
            <Section
                ...
                count={paths.length}
                emptyMessage="No paths saved. Discover learning paths!"
                createHref="/dashboard/paths/new"
                createLabel="New"
            >
                ...
                >
                    <div className="flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h2 className="text-lg font-bold text-text-main group-hover:underline">Exercises</h2>
