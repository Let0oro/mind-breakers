    ...
    return (
        <div className="animate-pulse">
            ...
            <div className="mb-8">
                ...
                <div className="h-4 w-96 bg-main dark:bg-surface rounded-lg mb-6"></div>

                {/* Search Bar Skeleton */}
                <div className="max-w-2xl">
                    <div className="h-14 w-full bg-main dark:bg-surface rounded-lg"></div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                    <div key={i} className="bg-main dark:bg-surface rounded-xl border border-border dark:border-border overflow-hidden">
