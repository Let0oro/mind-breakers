    ...
    return (
        <div className="animate-pulse">
            ...
            <div className="mb-8">
                ...
                <div className="h-4 w-96 bg-[#1a232e] rounded-lg mb-6"></div>

                {/* Search Bar Skeleton */}
                <div className="max-w-2xl">
                    <div className="h-14 w-full bg-[#1a232e] rounded-lg"></div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                    <div key={i} className="bg-[#1a232e] rounded-xl border border-[#3b4754] overflow-hidden">
