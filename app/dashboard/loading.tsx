        ...
        <div className="animate-pulse">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-6 mb-8">
                <div className="flex flex-col gap-2 w-full md:w-auto">
                    <div className="h-8 w-64 bg-white dark:bg-[#1a232e] rounded-lg mb-1"></div>
                    <div className="h-4 w-48 bg-white dark:bg-[#1a232e] rounded-lg"></div>
                </div>
                <div className="h-11 w-32 bg-white dark:bg-[#1a232e] rounded-lg shrink-0"></div>
            </div>
                ...
                <section>
                    <div className="flex items-center justify-between mb-4">
                        <div className="flex items-center gap-2">
                            ...
                            <div className="h-6 w-48 bg-white dark:bg-[#1a232e] rounded"></div>
                        </div>
                        <div className="h-4 w-16 bg-white dark:bg-[#1a232e] rounded"></div>
                    </div>
