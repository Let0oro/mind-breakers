    ...
    return (
        <>
            ...
            <button
                ...
                className="md:hidden fixed top-4 left-4 size-11 z-50 px-2 py-2.5 bg-[#101922] text-white rounded-md border border-[#3b4754] hover:bg-[#283039]"
            ...
            <aside
                className={`
          fixed inset-y-0 left-0 z-50 w-64 flex flex-col justify-between border-r border-[#3b4754] bg-[#f6f7f8] dark:bg-[#101922] p-4 
        ...
        `}
            >
                <div className="flex flex-col gap-8">
                    ...
                    <div className="flex items-center gap-3 px-2 mt-8 md:mt-0">
                        ...
                        <div className="flex flex-col">
                            <h1 className="text-sm font-bold text-black dark:text-white truncate max-w-[140px]">
                ...
                <Link
                    ...
                    className="flex w-full items-center justify-center gap-2 rounded-lg h-11 bg-[#137fec] text-white text-sm font-bold transition-transform hover:bg-[#137fec]/90 active:scale-95"
                    onClick={() => setIsOpen(false)}
                >
