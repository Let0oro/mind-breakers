        ...
        <div className="container mx-auto px-4 py-8">
            <div className="flex flex-col items-center justify-center min-h-[60vh] text-center space-y-6">
                <div className="relative">
                    ...
                    <span className="material-symbols-outlined text-8xl text-[#137fec] relative z-10">groups</span>
                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-12 w-full max-w-3xl text-left">
                    <div className="p-6 bg-white dark:bg-[#1a232e] rounded-xl border border-gray-200 dark:border-[#3b4754]">
