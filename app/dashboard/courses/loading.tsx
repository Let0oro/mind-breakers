    ...
    return (
        <div className="animate-pulse">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-6">
                {[1, 2, 3, 4, 5, 6].map((i) => (
                    <div key={i} className="bg-white dark:bg-[#1a232e] rounded-xl overflow-hidden border border-gray-200 dark:border-[#3b4754]">
                        {/* Thumbnail */}
                        ...
                        <div className="p-5 flex flex-col gap-3">
                            ...
                            <div className="flex items-center justify-between mt-auto pt-3 border-t border-gray-200 dark:border-[#3b4754]">
                                <div className="flex items-center gap-2">
                                    <div className="w-4 h-4 bg-[#3b4754] rounded-full"></div>
