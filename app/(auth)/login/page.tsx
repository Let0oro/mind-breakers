        ...
        <form onSubmit={handleLogin} className="space-y-6">
          ...
          >
            {loading.email ? (
              ...
              <span>Log In to MindBreaker</span>
            )}
          </button>
          ...
          <div className="grid grid-cols-2 gap-4">
            <button
              ...
              disabled={loading.email || loading.google || loading.github}
              className="flex items-center justify-center gap-2 h-12 rounded-xs border border-border dark:border-border bg-main dark:bg-transparent text-text-main text-sm font-semibold hover:bg-surface dark:hover:bg-surface-dark transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              {loading.google ? (
